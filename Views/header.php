			...
			<div class="col-md-1 col-sm-4 col-xs-4 text-center"> 
				...
				if(!isset( $_SESSION['id'] ) || $_SESSION['id'] == ''){
					...
					<ul class="dropdown-menu">
						<li><a href="./login.php" data-toggle="modal">Login</a></li>
					...
					echo '
					<ul class="dropdown-menu">
						<li><a href="./profile.php" data-toggle="modal">Profile</a></li>
		...
		<div class="modal-content">
			...
			<form method="POST" action="../Controllers/modal_submit_controller.php" class="form">
				<div class="row">
					...
					<div class="col-sm-4">
						<div class="form-group">
						<input type="number" min="1" max="999999999999999" step="0.01" id="from_amount" name="from_amount" style="width: 100%;" class="form-control" placeholder="0.00" required>
					</div>
					</div>
				</div>
